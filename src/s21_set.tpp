...
//        return allocator.max_size();
    ...
    template<class key_type, class Compare>
    std::pair<typename set<key_type, Compare>::iterator, bool> set<key_type, Compare>::insert(const value_type &value) {
    ...
    template<class key_type, class Compare>
    typename set<key_type, Compare>::iterator set<key_type, Compare>::find(const key_type &key) {
...
//            std::cout << "hello" << std::endl;
    ...
    template<class key_type, class Compare>
    typename set<key_type, Compare>::read_black_node set<key_type, Compare>::last_right() const {
        read_black_node tmp = this->set_node_->get_root();
    ...
    // ConstIterator
    template<class key_type, class Compare>
    typename set<key_type, Compare>::read_black_node set<key_type, Compare>::ConstIterator::next_value() {
    ...
    template<class key_type, class Compare>
    bool set<key_type, Compare>::ConstIterator::node_have_grand_father_n_father_right()  {
    ...
    template<class key_type, class Compare>
    bool set<key_type, Compare>::ConstIterator::node_have_grand_father_n_father_left()  {
    ...
    template<class key_type, class Compare>
    typename set<key_type, Compare>::read_black_node set<key_type, Compare>::ConstIterator::prev_value() {
    ...
    template<class key_type, class Compare>
    typename set<key_type, Compare>::ConstIterator& set<key_type, Compare>::ConstIterator::operator++() {
    ...
    template<class key_type, class Compare>
    typename set<key_type, Compare>::ConstIterator set<key_type, Compare>::ConstIterator::operator--(int) {
        auto iter = *this;
        --(*this);
        return iter;
    ...
    template<class key_type, class Compare>
    template<class... Args>
    std::vector<std::pair<typename set<key_type, Compare>::iterator, bool>> set<key_type, Compare>::emplace(Args &&...args) {
        std::vector<std::pair<iterator, bool>> result;
        std::vector<typename set<key_type, Compare>::value_type> argsVector = {args...};
